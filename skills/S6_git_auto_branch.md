...
echo "✅ Đã push branch ai/w1-excel-handler. Vui lòng review và merge."
```
...
```
Wave 0 hoàn thành → User merge ai/w0-foundation vào main
                  → Wave 1 agents tạo branch từ main mới

Wave 1 hoàn thành → User merge 4 branches (w1-*) vào main
                  → Wave 2 agents tạo branch từ main mới

Wave 2 hoàn thành → User merge vào main
                  → Wave 3 agents tạo branch từ main mới
```

> **QUAN TRỌNG:** Agent Wave N+1 PHẢI base từ `main` (đã merge Wave N). KHÔNG base từ branch của agent khác.
